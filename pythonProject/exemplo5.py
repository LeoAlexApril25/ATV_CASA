...
def resultado():
    ...
    if var_resultado <= 900:
        ...
        var_Totaldesconto = var_INSS + var_Sindicato
        ...
        Label_sainda5.configure(text=f"O Total de desconto é: R${var_Totaldesconto:.2f}")
        Label_sainda6.configure(text=f"O Salario Liquido é: R${var_Liquido:.2f}")
        ...
        Label_sainda2.configure(text=f"O IR é: R${var_ir:.2f}")
        Label_sainda3.configure(text=f"O INSS é: R${var_INSS:.2f}")
        Label_sainda4.configure(text=f"O FGTS é: R${var_FGTS:.2f} ")
        Label_sainda5.configure(text=f"O Total de desconto é: R${var_Totaldesconto:.2f}")
        Label_sainda6.configure(text=f"O Salario Liquido é: R${var_Liquido:.2f}")
...
Label_sainda3 = customtkinter.CTkLabel(janela, text=" INNS (10%) :")
